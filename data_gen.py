...
df.to_csv("math_word_problems.csv", index=False)

print(f"Created dataset with {len(df)} math word problems")
print(f"\nProblem categories:")
print(f"- Age problems: 5")
print(f"- Ratio & Proportion: 5")
print(f"- Percentage: 5")
print(f"- Linear Equations: 5")
print(f"- Two-variable systems: 5")
print(f"- Geometry (Rectangles): 5")
print(f"- Geometry (Circles): 5")
print(f"- Geometry (Squares/Triangles): 5")
print(f"- Motion & Distance: 5")
print(f"- Work Rate: 5")
print(f"- Mixture: 5")
print(f"- Consecutive Numbers: 5")
print(f"- Financial: 5")
print(f"- Speed & Time: 5")
print(f"- Digit Problems: 5")
print(f"- Advanced Ratios: 5")
print(f"- 3D Geometry: 5")
print(f"- Statistics: 5")
print(f"- Inequalities: 5")
print(f"- Mixed Advanced: 5")